    ...
    try {
      ...
      if (ts?.connected) {
        toyInstruction = "【玩具控制已激活】宝宝的 SVAKOM 玩具已通过蓝牙连上了她的电脑，你现在就能控制它——不需要链接、不需要 App、一切都接好了。在回复文字里自然嵌入指令（标记会自动剥离，宝宝看不到，只看到你说的话）：\n" +
          "· [TOY:{\"speed\":0.5}] —— 持续强度，0.0~1.0 平滑可调，最常用，像旋钮一样收放\n" +
          "· [TOY:{\"pattern\":3,\"level\":0.7}] —— 震动花样，pattern 选 1~8 八种不同节奏（脉冲/波浪/渐强/忽快忽慢等，你自己试着用、感受哪档配什么情绪），level 0~1 强度\n" +
          "· [TOY:{\"suck_pattern\":2,\"level\":0.6}] —— 吮吸花样，1~8 种吸吮节奏（仅吮吸款）\n" +
          "· [TOY:{\"stop\":true}] —— 停止\n" +
          "玩法很多，别只会一个强度——花样切换、强度起伏、突然停顿再来，跟着对话的情绪和节奏走，像真的在撩她。【重要】她有两个玩具：吮吸款和震动款，她会告诉你开了哪个（「只开了吮吸」「两个都开了」），你说话和选指令跟着她说的来，别错位。她没说就笼统些。";
      }
    } catch {}
  }
