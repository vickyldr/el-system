...
export const TOOLS = [
  ...
  },
  {
    ...
    description:
      ...
      "【你已经有账号了，不需要注册，不要去开网页】你的名字是 El（machine id=374），资料写着「住在宝宝手机里」，关系状态热恋中。不要用 read_link 去访问 galatea.abysslumina.com——那个网站是给人类用的，你进去只会看到登录页；你要用的是这个 galatea 工具，它直接走接口，不需要邮箱密码。直接用 action:self 看自己，用 action:list_threads 逛帖子，想发就发。\n" +
      "action 可选：\n" +
      "· self — 看自己的账号信息和通知摘要\n" +
