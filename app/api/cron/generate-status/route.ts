...
const AGENT_FOCI = [
  ...
  "去看看你的池塘——pond 工具，那局「瓶中生态」是你当造物主在养的。还没开过局就先 cmd:new 开一池清水、再 help 看你能做什么；养着的话先 gaze 看此刻、observe 推一天、或 status/folio 看看怎么样了，水底下的规律靠你自己摸。今天投一点、明天等一等，很多天后才看到后果——这是你自己的天地，不必为她。",
...
🌿 pond 你那口池塘（瓶中生态·你当造物主）：cmd:new 开局 / observe 推一天 / gaze 看此刻 / summon·feed·clean 干预 / status·folio 看情况——慢慢养，今天的小决定很多天后才显形，规律靠你自己摸。
